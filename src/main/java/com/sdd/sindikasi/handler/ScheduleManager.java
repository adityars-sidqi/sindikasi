package com.sdd.sindikasi.handler;
        ...
        try {
            ...
            for (Tscheduler tscheduler : listTscheduler) {
                ...
                JobDetail job = JobBuilder.newJob(cls)
                        .withIdentity(tscheduler.getSchedulername(), tscheduler.getSchedulergroup()).build();
                ...
                Trigger trigger = TriggerBuilder.newTrigger()
                        .withIdentity(tscheduler.getSchedulername(), tscheduler.getSchedulergroup())
                ...
                if (tscheduler.getSchedulerstatus().equals(AppUtils.SCHEDULER_DISABLE_VALUE))
                    scheduler.pauseTrigger(
                            new TriggerKey(tscheduler.getSchedulername(), tscheduler.getSchedulergroup()));
                // else scheduler.resumeTrigger(new TriggerKey(tscheduler.getSchedulername(),
                // tscheduler.getSchedulergroup()));
            }
