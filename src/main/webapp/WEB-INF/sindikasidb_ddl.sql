...
CREATE TABLE MDEBITUR (
	...
	PICNAME CHAR(40) DEFAULT '',
	PICPOSITION CHAR(40) DEFAULT '',
	PICPHONE CHAR(40) DEFAULT '',
	PICEMAIL CHAR(100) DEFAULT '',
	UPDATEDBY CHAR(30) DEFAULT '',
	LASTUPDATED TIMESTAMP
);
...
CREATE TABLE TPIPELINE  (
	...
	PARTICIPANTPORTION DECIMAL(17,0) DEFAULT 0,
	PARTICIPANTPORTIONCURRENCY CHAR(5) DEFAULT '',
	...
	TERMLOAN DECIMAL(17,0) DEFAULT 0, /* ADD */
	CORPLOAN DECIMAL(17,0) DEFAULT 0, /* ADD */
...
CREATE TABLE TPORTOPAYSCHEDULE  (
	...
	MONTHSCHEDULE CHAR(30) DEFAULT '', /* EX: JANUARI, MARET, JUNI -> 1;3;6 */
	UPDATEDBY CHAR(30) DEFAULT '',
	LASTUPDATED TIMESTAMP
);
...
CREATE TABLE TPORTOPAYMENT (
	TPORTOPAYMENTPK INTEGER NOT NULL PRIMARY KEY , 
